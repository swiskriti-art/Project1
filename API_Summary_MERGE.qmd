...
#hardcoded weighted columns -- want to change to loop
...
tib$FER_sqwgt <- (tib$FER^2) * tib$PWGTP
...
summaryfx(tib)
#summaryfx(tib, numvars = c("GASP","JWAP"), charvars = "HHL_fac")
...
```{r}
plotfx <- function(tib, numvars = "GASP", charvars = "SEX_fac"){
...
geom_boxplot() +
  #labs method from O'Reilly R for Data Science
  labs(
    title = paste0(numvars," Values by ",charvars),
...
```{r}
#test plot function
plotfx(tib,numvars = c("FER"),charvars = "SEX_fac")
